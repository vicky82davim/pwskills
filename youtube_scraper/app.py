                                ...
                                for j in con:
                                        ...
                                        if 'richItemRenderer' in j:
                                                if 'thumbnail' in j['richItemRenderer']['content']['videoRenderer']:
                                                        ...
                                                        title1 = j['richItemRenderer']['content']['videoRenderer']['title']['runs'][0]['text']
                                                        ...
                                                        video_details.append(vdtl)
                                                        count = count+1
        logging.info("log my final result {}".format(video_details))
        return render_template('result.html', video_details=video_details)
